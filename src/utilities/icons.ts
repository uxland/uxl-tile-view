...
<iron-iconset-svg name="tile-view-icons" size="24">
 <svg>
   <defs>
     ...
     <g id="minimize"><path d="M6.77 13.31v1.31h1.69L5 18.08l.92.92 3.46-3.46v1.69h1.31v-3.92zM18.08 5l-3.47 3.46V6.77h-1.3v3.92h3.92V9.38h-1.69L19 5.92zm-4.77 8.31v3.92h1.31v-1.69L18.08 19l.92-.92-3.46-3.46h1.69v-1.31zM5.92 5L5 5.92l3.46 3.46H6.77v1.31h3.92V6.77H9.38v1.69z"/></g>
   </defs>
 </svg>
</iron-iconset-svg>`;
